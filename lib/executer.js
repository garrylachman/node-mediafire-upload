...
module.exports = class Executer extends EventEmitter {
  ...
  startUploadJob(uploadItem) {
    return new Promise(async((resolve, reject) => {
      ...
      await(this.page.evaluateJavaScript(`function(){ return Mj(tH.currentFolder.folderkey|"myfiles"); }`));
      setTimeout(async(() => {
        //console.log(this.page);
        console.log("upload item", uploadItem.uploadItemJob);

        //await(this.page.uploadFile('#step4_html5_file_input_0', uploadItem.uploadItemJob.file));
